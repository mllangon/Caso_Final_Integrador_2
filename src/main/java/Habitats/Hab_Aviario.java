...
public class Hab_Aviario extends Habitat {
    public static final Hab_Aviario ZONA_1 = new Hab_Aviario(25, 60, true, 5, 3);
    public static final Hab_Aviario ZONA_2 = new Hab_Aviario(23, 70, false, 10, 2);
    public static final Hab_Aviario ZONA_3 = new Hab_Aviario(20, 50, true, 15, 5);
    public static final Hab_Aviario ZONA_4 = new Hab_Aviario(27, 60, false, 20, 1);
