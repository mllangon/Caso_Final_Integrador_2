...
public class Hab_Herpetario extends Habitat {
    ...
    public static final Hab_Herpetario ZONA_2 = new Hab_Herpetario(30, 70, true, 0.7, 12, "Piedras y troncos");
    ...
    public static final Hab_Herpetario ZONA_5 = new Hab_Herpetario(28, 50, true, 2, 12, "Piedras y troncos");
