...
public class Mamifero extends Animales {
    ...
    public static final Mamifero LEON_M = new Mamifero("León macho", 7, "Saludable", "Carnívoro", "Agresivo", "Pelaje corto y dorado");
    public static final Mamifero LEON_H = new Mamifero ("León hembra", 5, "Saludable", "Carnívoro", "Agresiva", "Pelaje corto y dorado");
    public static final Mamifero TIGRE_M = new Mamifero("Tigre", 4, "Enfermo", "Carnívoro", "Agresivo", "Pelaje corto y a rayas");
    public static final Mamifero TIGRE_H = new Mamifero("Tigresa", 3, "Saludable", "Carnívoro", "Agresiva", "Pelaje corto y a rayas");
    public static final Mamifero OSO = new Mamifero("Oso", 10, "Saludable", "Omnívoro", "Pacífico", "Pelaje largo y marrón");
    public static final Mamifero CHIMPANCE_P = new Mamifero("Chimpancé madre", 12, "Saludable", "Omnívoro", "Sociable", "Pelaje corto y negro");
